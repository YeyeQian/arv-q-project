...
/*This file (riscv-opc.c) is in directory of "xuantie-gnu-toolchain/riscv-binutils/opcodes"*/
...
/* Custom instructions.  */
{"pqccsrrw",           0, INSN_CLASS_V,  "d,t,Vi",      MATCH_PQCCSRRW, MASK_PQCCSRRW, match_opcode, 0 },
{"vbutterfly.ct.vvm",  0, INSN_CLASS_V,  "Vd,Vt,Vs,V0", MATCH_BFCT, MASK_BFCT, match_opcode, 0 },
{"vbutterfly.gs.vvm",  0, INSN_CLASS_V,  "Vd,Vt,Vs,V0", MATCH_BFGS, MASK_BFGS, match_opcode, 0 },
{"vmod.add.vv",        0, INSN_CLASS_V,  "Vd,Vt,VsVm",  MATCH_MODADDVV, MASK_MODADDVV, match_opcode, 0 },
{"vmod.sub.vv",        0, INSN_CLASS_V,  "Vd,Vt,VsVm",  MATCH_MODSUBVV, MASK_MODSUBVV, match_opcode, 0 },
{"vmod.mul.vv",        0, INSN_CLASS_V,  "Vd,Vt,VsVm",  MATCH_MODMULVV, MASK_MODMULVV, match_opcode, 0 },
{"vmod.add.vx",        0, INSN_CLASS_V,  "Vd,Vt,sVm",   MATCH_MODADDVX, MASK_MODADDVX, match_opcode, 0 },
{"vmod.sub.vx",        0, INSN_CLASS_V,  "Vd,Vt,sVm",   MATCH_MODSUBVX, MASK_MODSUBVX, match_opcode, 0 },
{"vmod.mul.vx",        0, INSN_CLASS_V,  "Vd,Vt,sVm",   MATCH_MODMULVX, MASK_MODMULVX, match_opcode, 0 },
{"vmod.basemul.vvm",   0, INSN_CLASS_V,  "Vd,Vt,Vs,V0", MATCH_MODBASEMUL, MASK_MODBASEMUL, match_opcode, 0 },
{"sample.rej.vx",      0, INSN_CLASS_V,  "Vd,Vt,s",     MATCH_REJSAMPLE, MASK_REJSAMPLE, match_opcode, 0 },
{"pack.vx",            0, INSN_CLASS_V,  "Vd,Vt,s",     MATCH_PACKVX, MASK_PACKVX, match_opcode, 0 },
{"unpack.vx",          0, INSN_CLASS_V,  "Vd,Vt,s",     MATCH_UNPACKVX, MASK_UNPACKVX, match_opcode, 0 },
{"keccak.loadm.v",     0, INSN_CLASS_V,  "Vt",       MATCH_KECCAKLOADM, MASK_KECCAKLOADM, match_opcode, 0 },
{"keccak.stores.v",    0, INSN_CLASS_V,  "Vd",       MATCH_KECCAKSTORES, MASK_KECCAKSTORES, match_opcode, 0 },
{"keccak.init",        0, INSN_CLASS_V,  "Vi",          MATCH_KECCAKINIT, MASK_KECCAKINIT, match_opcode, 0 },
{"keccak.absorb",      0, INSN_CLASS_V,  "d,s",         MATCH_KECCAKABSORB, MASK_KECCAKABSORB, match_opcode, 0 },
{"keccak.squeeze",     0, INSN_CLASS_V,  "Vi",          MATCH_KECCAKSQUEEZE, MASK_KECCAKSQUEEZE, match_opcode, 0 },
{"unpacks.vx",         0, INSN_CLASS_V,  "Vd,Vt,s",     MATCH_UNPACKSVX, MASK_UNPACKSVX, match_opcode, 0 },
{"chacha20.init.v",    0, INSN_CLASS_V,  "Vt",       MATCH_CHACHA20INITV, MASK_CHACHA20INITV, match_opcode, 0 },
{"samplerz",           0, INSN_CLASS_D,  "D,S,T", MATCH_SAMPLERZ, MASK_SAMPLERZ, match_opcode, 0 },
{"bitseqsll.vx",       0, INSN_CLASS_V,  "Vd,Vt,s",     MATCH_BITSEQSLL, MASK_BITSEQSLL, match_opcode, 0 },
{"clmul.vx",           0, INSN_CLASS_V,  "Vd,Vt,s",     MATCH_VXCLMUL, MASK_VXCLMUL, match_opcode, 0 },
{"clmul.vv",           0, INSN_CLASS_V,  "Vd,Vt,Vs",     MATCH_VVCLMUL, MASK_VVCLMUL, match_opcode, 0 },
/* vector crypto instructions.  */
{"vcpop.v",            0, INSN_CLASS_V,  "Vd,VtVm",     MATCH_VCPOPV, MASK_VCPOPV, match_opcode, 0},
