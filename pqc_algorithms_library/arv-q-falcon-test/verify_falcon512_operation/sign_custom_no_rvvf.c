 ...
 */
static void
ffLDL_fft_inner_custom_no_rvvf(fpr *restrict tree,
	fpr *restrict g0, fpr *restrict g1, unsigned logn, fpr *restrict tmp)
{
	 ...
	 */
	ffLDL_fft_inner_custom_no_rvvf(tree + n,
		g1, g1 + hn, logn - 1, tmp);
	ffLDL_fft_inner_custom_no_rvvf(tree + n + ffLDL_treesize(logn - 1),
		g0, g0 + hn, logn - 1, tmp);
}
 ...
 */
static void
ffLDL_fft_custom_no_rvvf(fpr *restrict tree, const fpr *restrict g00,
...
/* see inner.h */
void
Zf(expand_privkey_custom_no_rvvf)(fpr *restrict expanded_key,
	...
	unsigned logn, uint8_t *restrict tmp)
{
	 ...
	 */
	ffLDL_fft_custom_no_rvvf(tree, g00, g01, g11, logn, gxx);
 ...
 */
static void
ffSampling_fft_dyntree_custom_no_rvvf(samplerZ_custom samp, 
	...
	unsigned orig_logn, unsigned logn, fpr *restrict tmp)
{
	...
	ffSampling_fft_dyntree_custom_no_rvvf(samp, z1, z1 + hn,
	...
	ffSampling_fft_dyntree_custom_no_rvvf(samp, z0, z0 + hn,
 ...
 */
static void
ffSampling_fft_custom_no_rvvf(samplerZ_custom samp,
	...
	fpr *restrict tmp)
{
	 ...
	 */
	Zf(poly_split_fft)(z1, z1 + hn, t1, logn);
	ffSampling_fft_custom_no_rvvf(samp, tmp, tmp + hn,
 ...
 */
static int
do_sign_tree_custom_no_rvvf(samplerZ_custom samp, int16_t *s2,
	...
	unsigned logn, fpr *restrict tmp)
{
	 ...
	 */
	ffSampling_fft_custom_no_rvvf(samp, tx, ty, tree, t0, t1, logn, ty + n);
 ...
 */
static int
do_sign_dyn_custom_no_rvvf(samplerZ_custom samp, int16_t *s2,
	...
	const uint16_t *hm, unsigned logn, fpr *restrict tmp)
{
	 ...
	 */
	ffSampling_fft_dyntree_custom_no_rvvf(samp,
 ...
 */
fpr
Zf(sampler_custom)(fpr mu, fpr isigma)
{
	fpr guass;
    guass.v = samplerz_double(mu.v, isigma.v);
	return guass;
}
	...
	const uint16_t *hm, unsigned logn, uint8_t *tmp)
{
	...
	for (;;) {
		 ...
		 */
		if (do_sign_tree_custom_no_rvvf(samp, sig,
	...
	const uint16_t *hm, unsigned logn, uint8_t *tmp)
{
	...
	for (;;) {
		 ...
		 * Do the actual signature.
		 */
		if (do_sign_dyn_custom_no_rvvf(samp, sig,
