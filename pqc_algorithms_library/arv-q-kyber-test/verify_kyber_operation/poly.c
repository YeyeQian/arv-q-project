...
/*************************************************
* Name:        poly_standard_to_bitreverse_all
*
* Description: Transfer the KYBER_N coefficients in a polynomial
...
{
  standard_to_bitreverse_all(r->coeffs);
}


/*************************************************
* Name:        poly_bitreverse_to_standard_all
*
* Description: Transfer the KYBER_N coefficients in a polynomial
...
{
  bitreverse_to_standard_all(r->coeffs);
}