...
/*************************************************
* Name:        polyvec_standard_to_bitreverse_all
*
* Description: Transfer the KYBER_N coefficients in each polynomial in polyvec
*              from standard order to bitreverse order (the order after NTT)
*
* Arguments:   - poly *r: pointer to input/output polynomial
**************************************************/
void polyvec_standard_to_bitreverse_all(polyvec *r)
{
  unsigned int i;
  for(i=0;i<KYBER_K;i++)
    poly_standard_to_bitreverse_all(&r->vec[i]);
}


/*************************************************
* Name:        polyvec_bitreverse_to_standard_all
*
* Description: Transfer the KYBER_N coefficients in each polynomial in polyvec
*              from bitreverse order (the order after NTT) to standard order 
*
* Arguments:   - poly *r: pointer to input/output polynomial
**************************************************/
void polyvec_bitreverse_to_standard_all(polyvec *r)
{
  unsigned int i;
  for(i=0;i<KYBER_K;i++)
    poly_bitreverse_to_standard_all(&r->vec[i]);
}