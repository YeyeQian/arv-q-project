...
static inline vuint32m8_t vmod_add_vv_u32m8(vuint32m8_t vx, vuint32m8_t vy) {
    vuint32m8_t vz;
    __asm__ __volatile__ ( "vmod.add.vv %[vd], %[vt], %[vs]"
    : [vd] "=vr"(vz)
    : [vt] "vr"(vx), [vs] "vr"(vy)
...
static inline vuint32m8_t vmod_mul_vv_u32m8(vuint32m8_t vx, vuint32m8_t vy) {
    vuint32m8_t vz;
    __asm__ __volatile__ ( "vmod.mul.vv %[vd], %[vt], %[vs]"
    : [vd] "=vr"(vz)
    : [vt] "vr"(vx), [vs] "vr"(vy)
...
static inline vuint32m8_t vmod_mul_vx_u32m8(vuint32m8_t vx, uint32_t op2) {
    vuint32m8_t vz;
    __asm__ __volatile__ ( "vmod.mul.vx %[vd], %[vt], %[op2]"
    : [vd] "=vr"(vz)
    : [vt] "vr"(vx), [op2] "r"(op2)
