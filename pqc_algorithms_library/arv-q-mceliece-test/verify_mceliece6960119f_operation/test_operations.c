...
bool test_crypto_kem_enc_custom(){
    uint8_t* ct_ref;
    ct_ref = (uint8_t*)malloc(crypto_kem_CIPHERTEXTBYTES);
    uint8_t* ct_res;
    ct_res = (uint8_t*)malloc(crypto_kem_CIPHERTEXTBYTES);
    uint8_t* ss_ref;
    ss_ref = (uint8_t*)malloc(crypto_kem_BYTES);
    uint8_t *ss_res;
    ss_res = (uint8_t*)malloc(crypto_kem_BYTES);
    int                 ret_val_ref;
    int                 ret_val_res;
    ...
    free(ct_ref),free(ct_res),free(ss_ref),free(ss_res);
