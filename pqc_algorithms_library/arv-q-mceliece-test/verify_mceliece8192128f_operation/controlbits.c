...
/* output position pos is by definition 1&(out[pos/8]>>(pos&7)) */
void controlbitsfrompermutation(unsigned char *out,const int16 *pi,long long w,long long n1)
{
  long long n = 1LL << GFBITS;
  int32 temp[2*(1LL << GFBITS)];
  int16 pi_test[1LL << GFBITS], diff;
  int i;
  unsigned char *ptr;
