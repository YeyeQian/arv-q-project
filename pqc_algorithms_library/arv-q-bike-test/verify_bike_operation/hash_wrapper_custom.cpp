...
**************************************************/
void sha3_384_custom(uint8_t *h, const uint8_t *in, size_t inlen)
{
  // unsigned int i;
  // uint64_t s[25];
  ...
  csr_keccakmode_rw(SHA3_384_MODE);
  keccak_absorb_custom(in, inlen, SHA3_384_RATE);
  keccak_squeezeblocks_custom(t, 1, SHA3_384_RATE, false);
