...
void vect_set_random_fixed_weight_noctx(uint32_t rand_u32[PARAM_OMEGA_R], uint64_t* v, uint16_t weight) {
...
void vect_set_random_fixed_weight_noctx_support(uint32_t rand_u32[PARAM_OMEGA_R],uint32_t* support, uint64_t* v, uint16_t weight) {
...
void vect_set_random_fixed_weight_xy(uint64_t* x, uint64_t* y, uint32_t* support, const unsigned char* sk_seed) {
    ...
    shake256(buffer,sizeof(buffer),sk_seed_pad,sizeof(sk_seed_pad));

    uint32_t* rand_u32_x = (uint32_t*)buffer;
    uint32_t* rand_u32_y = (uint32_t*)buffer + PARAM_OMEGA;

    vect_set_random_fixed_weight_noctx(rand_u32_x,x,PARAM_OMEGA);
    vect_set_random_fixed_weight_noctx_support(rand_u32_y,support,y, PARAM_OMEGA);
}
...
void vect_set_random_fixed_weight_r1r2e(uint64_t* r1, uint64_t* r2, uint32_t* support,uint64_t* e, const unsigned char* theta) {
    ...
    shake256(buffer, sizeof(buffer), theta_pad, sizeof(theta_pad));
    ...
    vect_set_random_fixed_weight_noctx(rand_u32_r1, r1, PARAM_OMEGA_R);
    vect_set_random_fixed_weight_noctx_support(rand_u32_r2,support,r2, PARAM_OMEGA_R);
    vect_set_random_fixed_weight_noctx(rand_u32_e, e, PARAM_OMEGA_E);
}
...
void vect_set_random_h(unsigned char* pk_seed, uint64_t* v) {
    ...
    shake256((uint8_t*)v, VEC_N_SIZE_BYTES, pk_seed_pad, sizeof(pk_seed_pad));
