...
int crypto_kem_enc(unsigned char *ct, unsigned char *ss, const unsigned char *pk, const uint64_t* m, const uint64_t* salt) {
    ...
    shake256(theta, SHAKE256_512_BYTES, tmp, sizeof(tmp));
    ...
    shake256(d, SHAKE256_512_BYTES, m_pad, sizeof(m_pad));
    ...
    shake256(ss, CRYPTO_BYTES, mc, sizeof(mc));
...
int crypto_kem_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk) {
    ...
    m_pad[VEC_K_SIZE_BYTES] = H_FCT_DOMAIN;
    shake256(d2,SHAKE256_512_BYTES,m_pad,sizeof(m_pad));
