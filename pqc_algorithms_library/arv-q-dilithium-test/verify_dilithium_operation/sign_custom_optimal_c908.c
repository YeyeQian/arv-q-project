...
/*************************************************
* Name:        crypto_sign_keypair_custom_optimal
*
...
/*************************************************
* Name:        crypto_sign_signature_custom_optimal
*
...
/*************************************************
* Name:        crypto_sign_custom_optimal
*
                ...
                const uint8_t *sk)
{
  ...
  crypto_sign_signature_custom_optimal(sm, smlen, sm + CRYPTO_BYTES, mlen, sk);
  *smlen += mlen;
  return 0;
}

/*************************************************
* Name:        crypto_sign_verify_custom_optimal
*
...
/*************************************************
* Name:        crypto_sign_open_custom_optimal
*
                     ...
                     const uint8_t *pk)
{
  ...
  *mlen = smlen - CRYPTO_BYTES;
  if(crypto_sign_verify_custom_optimal(sm, CRYPTO_BYTES, sm + CRYPTO_BYTES, *mlen, pk)) {
    goto badsig;
  }
  else {
